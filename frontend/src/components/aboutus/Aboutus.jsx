            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                <h2 className="text-dark mb-8 text-3xl font-bold sm:text-4xl">
                  Your Gateway to Exploring India
                </h2>
                <p className="text-body-color mb-8 text-base">
                  We offer reliable travel planning and curated experiences across India, focused on comfort, authenticity, local insights, and seamless travel coordination
                </p>
                <p className="text-body-color mb-12 text-base">
                  From iconic landmarks to hidden gems, we ensure smooth journeys with trusted support and personalized service, making every trip memorable and hassle-free.
                </p>
              </div>
            </div>
          </div>
