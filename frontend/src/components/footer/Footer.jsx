...
const Footer = () => {
  return (
    <div className="w-full bg-black py-16 px-10 grid md:grid-cols-2 gap-8 text-gray-300 bottom-0">
      <div className="">
        <h3 className="text-2xl font-bold text-[#41A4FF]">Voyager</h3>
        <p className="py-4">
          Voyager helps you explore India through curated travel experiences, seamless planning, and trusted guidance, making every journey meaningful and memorable.
        </p>
