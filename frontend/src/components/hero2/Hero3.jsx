            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                <p className="text-body-color mb-8 text-base">
                  Travel with us and discover meaningful journeys across India, where every experience is thoughtfully crafted for comfort, authenticity, and lasting memories.
                </p>
                <p className="text-body-color mb-12 text-base">
                  From breathtaking landscapes to rich cultural heritage, we help you explore responsibly and joyfully, creating unforgettable moments while respecting nature, communities, and traditions.
                </p>
              </div>
            </div>
