...
const HiddenPlaces = () => {
  return (
    ...
    //     <div>
    //       <img
    //         src="https://firebasestorage.googleapis.com/v0/b/Voyager-7264c.appspot.com/o/dsc_0128.webp?alt=media&token=a06ac6b6-450a-49ac-9330-e345e9e0e755"
    //         alt=""
    //       />
    //     </div>
    //   </div>
    ...
    <div class="mx-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 mt-10">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 mt-10 gap-5">
        ...
        <div class="text-xl">
          ...
          <p>
            ...
            country of INDIA, near the town of Elkaduwa in the Matale
            ...
            tourist attraction in INDIA. Visitors can enjoy a variety of
            ...
            peaceful destination in INDIA that offers a perfect getaway from
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 mt-20 gap-5">
        <div class="md:order-last">
          <img
            src="https://firebasestorage.googleapis.com/v0/b/Voyager-7264c.appspot.com/o/IMG_9666.JPG?alt=media&token=8be80c0f-0646-4f38-b468-43eb95c3b54b"
            alt=""
          ></img>
        </div>
        <div class="text-xl">
