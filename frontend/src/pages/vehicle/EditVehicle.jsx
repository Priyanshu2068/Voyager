  ...
  return (
    <div>
        ...
        <h1 className='text-lg lg:text-2xl font-bold py-6  text-center'>Edit Vehicle</h1>
            ...
            <input type='text' className='border rounded-lg w-full p-2 mb-6 mt-2' defaultValue={state.location} placeholder='Delhi' required onChange={(e) => setLocation(e.target.value) }/>
